import { MARK_BOLD, MARK_CODE, MARK_ITALIC, MARK_STRIKETHROUGH, toggleList, unwrapList, } from '@udecode/slate-plugins';
...
export const autoformatRules = [
    ...
    },
    {
        ...
        preFormat,
        format: (editor) => {
            toggleList(editor, Object.assign(Object.assign({}, options), { typeList: options.ul.type }));
        },
    },
    {
        type: options.li.type,
        ...
        preFormat,
        format: (editor) => {
            toggleList(editor, Object.assign(Object.assign({}, options), { typeList: options.ol.type }));
        },
    },
    {
